	...
	if (isset($_POST['Lista']) && $_POST['Lista'] != ''){
    	...
    	while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
			...
			<a href="../"><img style="margin: 1px; padding: 1px; border: 1px solid gray" alt="'.$row['nome'].'" title="'.$row['nome'].'" src="'.$foto_aluno.'?'.$rd.'"></a></td></tr><tr><td align="center">'.$primeiroNome.'</td></tr><tr><td align="center">'.$ano.$turma.'</td></tr></table>'.$mostraFotos;
		}
