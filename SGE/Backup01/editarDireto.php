...
echo $observacao;
$sql = "update tb_aluno set ano='$ano',turma='$turma',turno='$turno',nome='$nome',nascimento='$nascimento',sexo='$sexo',situacaoMatricula='$situacao',dataMatricula='$matriculado',
					...
					<br><table border="0">
						<tr>
							...
							<img style="margin: 1px; padding: 1px; border: 1px solid gray" width="200" alt="'.$row['nome'].'" title="'.$row['nome'].'" src="'.$foto_aluno.'?'.$rd.'"><br>
                                <input align="center" type="submit" value="Apagar" name="btnApagar">
								<hr width="50%">
								<hr width="30%">
								<hr width="10%">
							</td>
