...
$escola = "Escola Municipal Francisco Vaz de Lima";
...
<input type="radio" value="0E" name="Lista" onchange="form.submit()">PE
<input type="radio" value="0F" name="Lista" onchange="form.submit()">PF
<HR>
...
<input type="radio" value="1F" name="Lista" onchange="form.submit()">1ºF
...
<input type="radio" value="2F" name="Lista" onchange="form.submit()">2ºF
...
<input type="radio" value="3F" name="Lista" onchange="form.submit()">3ºF
...
<input type="radio" value="4E" name="Lista" onchange="form.submit()">4ºE
...
<input type="radio" value="AD" name="Lista" onchange="form.submit()">AD
