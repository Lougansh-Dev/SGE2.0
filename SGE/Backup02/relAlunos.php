...
if (isset($_POST['salvar']) && $_POST['dropCodigo'] != '') {
    ...
    // Atualizar outros dados do aluno, se necessário
    $nome = $_POST['nome'];
    // Adicione aqui as outras informações a serem atualizadas
    ...
    // Atualizar a foto do aluno no banco de dados
    $sql = "UPDATE tb_aluno SET foto = '$novoNome' WHERE cgm = '$dropCodigo'";
