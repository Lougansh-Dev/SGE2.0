...
observacao='$observacao',dificuldade='$dificuldade',robotica='$robotica' where cgm = '$cgm'"; 
...
if($_SERVER['REQUEST_METHOD']=='GET') {
	if(isset($_GET['cgm'])){
        ...
        //$sql = "SELECT a.cgm, a.ano, a.turma, a.nome, a.nascimento, a.sexo, a.situacaoMatricula, a.dataMatricula, a.observacao, a.dificuldade, a.robotica, t.turno FROM tb_aluno a, tb_turma t WHERE a.cgm = $aluno and a.turma = t.turma and a.ano = t.ano";
        $sql = "SELECT a.cgm, a.ano, a.turma, a.nome, a.nascimento, a.sexo, a.dataMatricula, a.observacao, a.dificuldade, a.robotica, t.turno
        FROM tb_aluno a
					...
					<br><table border="0">
						<tr>
							...
							<img style="margin: 1px; padding: 1px; border: 1px solid gray" width="200" alt="'.$row['nome'].'" title="'.$row['nome'].'" src="'.$foto_aluno.'?'.$rd.'"><br>
                                <input align="center" type="submit" value="Apagar" name="btnApagar"><input align="center" name="foto" type="file" accept="image/*"><input type="submit" value="Alterar" name="btnAlterarFoto">
								<hr width="50%">
								<hr width="30%">
								<hr width="10%">
							</td>
